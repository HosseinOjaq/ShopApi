...
namespace Api.Admin.Controllers.v1
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<ApiResult<PaginatedList<ProductCategoryById>>> CategoryProductGetBayId(int id, int? pageNumber, CancellationToken cancellationToken)
        {
            var result = await productRepository.GetProductsByCategoryIdAsync(id, pageNumber, cancellationToken);
            return result;
        }
